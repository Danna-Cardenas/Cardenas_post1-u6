...
public class ProductoServlet extends HttpServlet {
    ...
    private void mostrarEdicion(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    ...
    private void guardar(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        Producto producto = extraerProducto(req, 0);
